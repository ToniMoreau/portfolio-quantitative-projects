...
class EditMetierPage(QWidget):
    ...
    def enregistrer_clicked(self):
        ...
        date_in = self.debut_metier_input.text().strip()
        date_out = self.fin_metier_input.text().strip()
        ...
        if profil_pro:
            ...
            date_in = profil_pro.date_in if not(date_in) else int(date_in)
            date_out = profil_pro.date_out if not(date_out) else int(date_out)
            ...
            date_in = None if not(date_in) else int(date_in)
            date_out = None if not(date_out) else int(date_out)
    ...
    def edit_metier_page(self):
        ...
        self.debut_metier_lbl = QLabel("En activité du mois n°")
        self.debut_metier_input = QLineEdit()
        self.debut_metier_input.setValidator(QIntValidator(0,1200))
        self.debut_metier_input.textChanged.connect(self.fin_periode_intvalidator_updt)
        
        self.fin_metier_lbl = QLabel("jusqu'au mois n°")
        self.fin_metier_input = QLineEdit()
        self.fin_metier_input.setValidator(QIntValidator(0,1200))
        self.etendu_lyt.addWidget(self.debut_metier_lbl)
        self.etendu_lyt.addWidget(self.debut_metier_input)
        self.etendu_lyt.addWidget(self.fin_metier_lbl)
        self.etendu_lyt.addWidget(self.fin_metier_input)
    ...
    def fin_periode_intvalidator_updt(self, debut):
        ...
        if debut:
            ...
            debut = 0
        self.fin_metier_input.setValidator(QIntValidator(debut, 1200))   

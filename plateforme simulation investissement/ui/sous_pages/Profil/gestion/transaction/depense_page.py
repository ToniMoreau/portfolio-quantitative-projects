...
class AjouterDepensePage(QWidget):
    ...
    def __init__(self, appContext : AppContext, session : Session):
        ...
        self.debut_depense_lbl = QLabel("Valable du")
        ...
        self.fin_depense_lbl = QLabel("jusqu'au")
    ...
    def update_periode_from_freq(self):
        if self.frequence_choix.currentText().strip() == "Ponctuel":
            self.debut_depense_lbl.setText("Pour le :")
            self.fin_depense_lbl.hide()
            self.fin_month_input.hide()
            self.fin_year_input.hide()
        else :
            self.debut_depense_lbl.setText("Valable du :")

...
class AjouterDepensePage(QWidget):
    ...
    def update_periode_from_freq(self):
        if self.frequence_choix.currentText().strip() == "Ponctuel":
            self.debut_depense_lbl.setText("Pour le mois n° :")
            self.fin_depense_lbl.hide()
            self.fin_depense_input.hide()
        else :
            self.debut_depense_lbl.setText("Valable du mois n° :")
            self.fin_depense_lbl.show()
            self.fin_depense_input.show()
    ...
    def enregistrer_clicked(self):
        ...
        if freq_choix == "Ponctuel":
            fin = debut
        else: fin = None if not(self.fin_depense_input.hasAcceptableInput()) else int(self.fin_depense_input.text().strip())
    ...
    def load(self):
        ...
        self.debut_depense_input.setText("")
        self.fin_depense_input.setText("")

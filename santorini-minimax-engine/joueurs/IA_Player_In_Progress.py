...
count_ok = False
class IAPlayerInProgress(IAPlayer):
    def __init__(self, nom, prenom, evaluation_n, depth, database_tuple):
        super().__init__(nom, prenom, depth, database_tuple)
        self.id_player = None
    ...
    def evaluate_montabilité(self, state : GameState):
        ...
        for wkr in workers_by_player[self.id_player]:
            ...
            for dl,dc in voisinage:
                ...
                diff_voisine =  hauteur_voisine - hauteur_wkr
        ...
        for wkr in workers_by_player[1 - self.id_player]:
            ...
            for dl,dc in voisinage:
                ...
                hauteur_voisine = hauteurs_plateau[lm][cm]
                diff_voisine = hauteur_voisine - hauteur_adv
                minime_montée = min(minime_montée, diff_voisine)
                if diff_voisine ==1:
                    has_good_voisin = True

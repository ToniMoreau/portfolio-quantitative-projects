...
class MainWindow(QMainWindow):
    def __init__(self, appContext : AppContext, session : Session):
        ...
        self.pages.addWidget(self.parametre_page) # index 1
        self.pages.addWidget(self.profil_page)    # index 2
        self.pages.addWidget(self.banque_page)    # index 3
        self.pages.addWidget(self.auth_page)      # index 4

        # Connecter les boutons à la navigation
        btn_accueil.clicked.connect(lambda: self.pages.setCurrentIndex(0))
        btn_params.clicked.connect(lambda: self.pages.setCurrentIndex(1))
        btn_profil.clicked.connect(self.btn_profil_clicked)
        self.btn_banque.clicked.connect(lambda: self.pages.setCurrentIndex(3))
    ...
    def on_auth_success(self, user):
        ...
        self.pages.setCurrentWidget(self.profil_page)  

...
class InfoHubPage(QWidget):
    ...
    def load_index(self, index):
        if index in (1,2,3,5) and self.scenario_service.scenario_actif is None:
    ...
    def host_widget(self):
        ...
        self.edit_scenario_btn.clicked.connect(lambda: self.load_index(4))
    ...
    def add_scenario_clicked(self):
        ...
        self.scenario_choix.setCurrentIndex(0)
        self.load_index(4)

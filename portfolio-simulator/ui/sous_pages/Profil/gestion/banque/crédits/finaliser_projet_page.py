...
class FinaliserProjetPage(QWidget):
    back_to_hub = Signal()
    def __init__(self, appContext : AppContext, session : Session):
        ...
        self.finaliser_hub_page = self.finaliser_projets_hub()
        self.finaliser_page = None
        self.stack = QStackedWidget()
        self.stack.addWidget(self.finaliser_hub_page) #index 0
        self.stack.addWidget(self.finaliser_page) #index 1
    ...
    def finaliser_projets_hub(self):
        page = QWidget()

...
class NouveauProjetPage(QWidget):
    ...
    def __init__(self, appContext : AppContext, session : Session):
        ...
        description_projet = QPlainTextEdit()
        description_projet.setPlaceholderText("Description du projet...")
        description_projet.setFixedHeight(100)
        ...
        layout.addWidget(description_projet)

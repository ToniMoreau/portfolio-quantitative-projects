...
from .actifs.actifs_page import ActifsPage
from .projets.projets_hub_page import ProjetsPage
...
class ProfilPage(QWidget):
    ...
    def __init__(self, appContext : AppContext, session : Session):
        ...
        #self.actifs_btn = QPushButton("Actifs")
        ...
        #sidebar_layout.addWidget(self.actifs_btn)
        ...
        """
        self.actifs_page = ActifsPage(self.appContext, self.session)
        self.gestion_projet = ProjetsPage(self.appContext, self.session)
        """
        ...
        #self.stack.addWidget(self.gestion_projet) 
        self.stack.addWidget(self.visualisation_page) #index 4
        #self.stack.addWidget(self.actifs_page) #index 5
        ...
        self.invest_btn.clicked.connect(lambda : self.load_by_index(3))
        ...
        #self.actifs_btn.clicked.connect(lambda : self.load_by_index(5))
